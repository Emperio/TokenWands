...
public class StrengthWand extends Wand {
    public StrengthWand(){

    }

    String wandName = "strength";
    ...
    public PotionEffect effect = new PotionEffect(PotionEffectType.INCREASE_DAMAGE, length, effectAmp);
